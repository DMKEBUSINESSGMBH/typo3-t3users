...
class tx_t3users_mod_userSearcher {
	...
	function showFEUser(&$content, $headline, &$items, $pager) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/mod/class.tx_t3users_mod_userSearcher.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/mod/class.tx_t3users_mod_userSearcher.php']);
}
