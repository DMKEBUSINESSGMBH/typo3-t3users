...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/hooks/class.tx_t3users_hooks_getMainFields.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/hooks/class.tx_t3users_hooks_getMainFields.php']);
}
