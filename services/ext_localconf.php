...
tx_rnbase_util_Extensions::addService($_EXTKEY,  't3users' /* sv type */,  'tx_t3users_services_feuser' /* sv key */,
  array(
...
tx_rnbase_util_Extensions::addService($_EXTKEY,  't3users' /* sv type */,  'tx_t3users_services_registration' /* sv key */,
	array(
...
tx_rnbase_util_Extensions::addService($_EXTKEY,  't3users' /* sv type */,  'tx_t3users_services_logging' /* sv key */,
  array(
...
tx_rnbase_util_Extensions::addService($_EXTKEY,  'auth' /* sv type */,  'tx_t3users_services_feuserauth' /* sv key */,
  array(
...
tx_rnbase_util_Extensions::addService($_EXTKEY,  't3users' /* sv type */,  'tx_t3users_services_email' /* sv key */,
  array(
...
tx_rnbase_util_Extensions::addService($_EXTKEY,  't3users' /* sv type */,  'tx_t3users_services_LoginForm' /* sv key */,
		array(
