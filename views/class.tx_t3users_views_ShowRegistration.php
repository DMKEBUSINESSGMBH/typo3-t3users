...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/views/class.tx_t3users_views_ShowRegistration.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3users/views/class.tx_t3users_views_ShowRegistration.php']);
}
?>