...
This action can be selected in the flexform of the plugin. It provides a form
to set a new password. The link to the page with the plugin has to provide the correct confirm string
for the user, so the form is displayed. The link can be send via mail from the login action (forgot password
function).
